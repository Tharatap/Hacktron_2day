    ...
    <header className="absolute top-0 inset-x-0 z-50 bg-[#ebfef1]/80 backdrop-blur-xl pt-safe border-b border-[#14241C]/10">
      <div className="h-16 px-4 flex items-center justify-between">
        ...
        <button
          ...
          title="ดูโปรไฟล์"
        >
          <div className="w-10 h-10 rounded-full border-2 border-white ring-2 ring-[#14241C] rotate-[-2deg] hard-shadow bg-white flex items-center justify-center text-xl">
            {user.avatar}
          </div>
